...
switch classifierType
 ...
 case {'randomForest'}
  ...
  [models] = classifierRandomForest(examples,labels);
 case {'deepLearning'}
  fprintf('trainClassifier: using %s with parameters\n',classifierType);
  [models] = classifierDeepLearning(examples,labels);
...
switch classifierType
 case {'knn','svmlight','pairwise','neural','nnets','svm','logisticRegression','randomForest','deepLearning'}
